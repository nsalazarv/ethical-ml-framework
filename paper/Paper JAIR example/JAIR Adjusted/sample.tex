...
\author{\name Nelson Salazar Valdebenito \email nesalazar@alumnos.uai.cl \\
       ...
       \addr Faculty of Engineering \& Sciences, Universidad Adolfo Ibáñez,\\
        Santiago 7941169, Chile\\
        \addr Millennium Nucleus for Social Data Science (SODAS),\\ 
        Santiago, Chile\\
...
In addition, AI cannot replicate many human capabilities. In the field of law, a lawyer must combine abstract thinking with skills to solve problems in situations of high uncertainty, in both the legal and factual domains; something a classification model cannot yet achieve \shortcite{surden2014machine}. That is, models cannot “reason” in the same manner as a human. Even the large language models — such as OpenAI's ChatGPT or Google's Gemini — that have become so popular recently are not capable of doing so, or at least not independently \shortcite{hao2023reasoning,wei2023chainofthought}. This is due to the fact that behind that black box, there are only probabilities and computations among vectors and matrices. Hence, models should be ``ethically trained'' in order to avoid these problems.
...
The problem is, the use of ethical tools and techniques for ML algorithms is not widespread when developing such models. This can be explained by the fact that there are no standardised processes to apply these tools \shortcite{agarwal2022sevenlayermodelstandardisingai}, and when such processes do exist, they are often seen by AI/ML developers as an extra burden rather than a tool for facilitating accountable employment of ML models \shortcite{https://doi.org/10.48550/arxiv.2206.02923,ijcai2023p735}. Additionally, their recent emergence and a lack of obligation for their use by both public and private organisations means that there is limited awareness of the importance of employing these tools to address ethical issues.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_base_normal_shap.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_improved_normal_shap.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_ref_base.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_maj_base.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_min_base.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_ref_improved.pdf}
    \caption{Model assessment for the reference group.}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_maj_improved.pdf}
    \caption{Model assessment for the major group.}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_min_improved.pdf}
    \caption{Model assessment for the min metrics group.}
...
SHAP Values were calculated using the data from the training set for both models. The averages are laid out in Table \ref{tab:pt_shap_stats_base_improved}.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_base_normal_shap.pdf}
    \caption{SHAP values distribution by feature (base model).}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_improved_normal_shap.pdf}
    \caption{SHAP values distribution by feature (improved model).}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_ref_base.pdf}
    \caption{Model assessment for the reference group.}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_maj_base.pdf}
    \caption{Model assessment for the major group.}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_min_base.pdf}
    \caption{Model assessment for the min metrics group.}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_ref_improved.pdf}
    \caption{Model assessment for the reference group.}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_maj_improved.pdf}
    \caption{Model assessment for the major group.}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_min_improved.pdf}
    \caption{Model assessment for the min metrics group.}
...
\acks{The authors would like to thank Chile's Public Criminal Defender’s Office for providing access to the data used in this study. This research was supported by IDB Lab, innovation laboratory of the Inter-American Development Bank Group [Project ATN/ME-18240-CH], National Agency for Research and Development, ANID + Applied Research Subdirection/ IDeA I+D 2023 grant [folio ID23I10357], ANID PIA/BASAL AFB240003, ANID-MILENIO-NCN2024\_103, CH-T1246 : Oportunidades de Mercado para las Empresas de Tecnología - Compras Públicas de Algoritmos Responsables, Éticos y Transparentes.
}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_base_uniform_shap.pdf}
    \caption{SHAP values distribution by feature (base model).}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_improved_shap.pdf}
    \caption{SHAP values distribution by feature (improved model).}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_ref_base_uni.pdf}
    \caption{Model assessment for the reference group.}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_maj_base_uni.pdf}
    \caption{Model assessment for the major group.}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_min_base_uni.pdf}
    \caption{Model assessment for the min metrics group.}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_ref_imp_uni.pdf}
    \caption{Model assessment for the reference group.}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_maj_imp_uni.pdf}
    \caption{Model assessment for the major group.}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/dt_aeq_min_imp_uni.pdf}
    \caption{Model assessment for the min metrics group.}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_base_uniform_shap.pdf}
    \caption{SHAP values distribution by feature (base model).}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_improved_uniform_shap.pdf}
    \caption{SHAP values distribution by feature (improved model).}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_ref_base_uni.pdf}
    \caption{Model assessment for the reference group.}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_maj_base_uni.pdf}
    \caption{Model assessment for the major group.}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_min_base_uni.pdf}
    \caption{Model assessment for the min metrics group.}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_ref_imp_uni.pdf}
    \caption{Model assessment for the reference group.}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_maj_imp_uni.pdf}
    \caption{Model assessment for the major group.}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1,width=1\textwidth]{JAIRAuthorKit/Images/pt_aeq_min_imp_uni.pdf}
    \caption{Model assessment for the min metrics group.}
\end{figure}
