...
\section*{Notes on revision made to manuscript: Fairness and Transparency in ML: A Methodological Framework}
...
\end{point}
\begin{reply}
Thank you for this important suggestion. We added aggregate comparison tables for each experiment, using the confusion-matrix counts already reported in the manuscript. The revised tables report effect-size differences and 95\% confidence intervals, and the surrounding text interprets these results as performance trade-offs rather than as evidence that one model is uniformly superior.
\end{reply}
...
\end{point}
\begin{reply}
Thank you for this framing suggestion. We kept the original title, \textit{Fairness and Transparency in ML: A Methodological Framework}, and revised the abstract, methodology, and conclusion to clarify the contribution as an applied fairness-auditing and bias-mitigation framework with explicit limitations.
\end{reply}
